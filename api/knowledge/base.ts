...
export const KNOWLEDGE_BASE: KnowledgeChunk[] = [
  ...
  },
  {
    ...
    content: {
      en: 'Ready Legacy is built on **3 pillars**: 1) **Be Ready** — organize your legal documents, assets, and final wishes. 2) **Leave Behind** — create personal messages, videos, and memories for your loved ones. 3) **Be Honored** — a next-level digital cemetery: create a personalized memorial place in a virtual world (island, moon, forest) reflecting culture, religion, and personality. Buy flowers, light candles — a memorial shop and main revenue driver.',
      de: 'Ready Legacy basiert auf **3 Säulen**: 1) **Bereit sein** — organisieren Sie Ihre rechtlichen Dokumente, Vermögenswerte und letzten Wünsche. 2) **Hinterlassen** — erstellen Sie persönliche Nachrichten, Videos und Erinnerungen. 3) **Gedenken** — ein digitaler Friedhof der nächsten Generation: erstellen Sie einen personalisierten Gedenkort in einer virtuellen Welt (Insel, Mond, Wald), der Kultur, Religion und Persönlichkeit widerspiegelt. Kaufen Sie Blumen, zünden Sie Kerzen an — ein Gedenkshop und Hauptumsatztreiber.',
      ru: 'Ready Legacy построен на **3 столпах**: 1) **Будьте готовы** — организуйте юридические документы, активы и последнюю волю. 2) **Оставьте после себя** — создайте личные послания, видео и воспоминания для близких. 3) **Be Honored** — цифровое кладбище нового уровня: создайте место памяти в виртуальном мире (остров, луна, лес) с учётом культуры, религии и личности усопшего. Покупайте цветы, ставьте свечи — магазин памяти и основной генератор дохода.',
      ua: 'Ready Legacy побудований на **3 стовпах**: 1) **Будьте готові** — організуйте юридичні документи, активи та останню волю. 2) **Залиште після себе** — створіть особисті послання, відео та спогади для близьких. 3) **Be Honored** — цифрове кладовище нового рівня: створіть місце пам\'яті у віртуальному світі (острів, місяць, ліс) з урахуванням культури, релігії та особистості померлого. Купуйте квіти, ставте свічки — магазин пам\'яті та основний генератор доходу.'
    },
    route: '/',
    priority: 9
  },
